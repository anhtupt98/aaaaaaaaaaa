...
<div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="students_view.php" class="small-box-footer">XEM THÊM <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="units_view.php" class="small-box-footer">XEM THÊM <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="courses_view.php" class="small-box-footer">XEM THÊM <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="Marks_view.php" class="small-box-footer">XEM THÊM <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
  ...
  <div class="box box-solid bg-green">
    ...
    <li>
        ...
        <div class="timeline-item">
            ...
            <h3 class="timeline-header"><a href="#">KIẾN THỨC VIỆT</a> ...</h3>
...
<footer class="main-footer">
    ...
    <strong>KIẾN THỨC VIỆT &nbsp;<a href="https://www.kienthucviet.info">KIẾN THỨC VIỆT</a>.</strong> All rights
    reserved.
  </footer>
</body>
</html>