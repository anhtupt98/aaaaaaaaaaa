...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>QUẢN LÝ</b>HỌC SINH</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">KIẾN THỨC VIỆT</li>
        <!-- Optionally, you can add icons to the links -->
        <li class="active"><a href="index.php"><i class="fa fa-dashboard"></i> <span>THÔNG BÁO</span></a></li>
        <li><a href="students_view.php"><i class="fa fa-users"></i> <span>HỌC SINH</span></a></li>
        <li><a href="units_view.php"><i class="fa fa-book"></i> <span>ĐƠN VỊ</span></a></li>
        <li><a href="courses_view.php"><i class="fa fa-pencil"></i> <span>KHÓA HỌC</span></a></li>
        <li><a href="attendance_view.php"><i class="fa fa-pie-chart"></i> <span>GHI DANH HỌC</span></a></li>
        <li><a href="Marks_view.php"><i class="fa fa-edit"></i> <span>ĐIỂM</span></a></li>
        <li><a href="academic_year_view.php"><i class="fa fa-calendar"></i> <span>NĂM HỌC</span></a></li>
        <li class="treeview">
          <a href="#"><i class="fa fa-cogs"></i> <span>HOẠT ĐỘNG</span>
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i>Kiến thức việt</a></li>
